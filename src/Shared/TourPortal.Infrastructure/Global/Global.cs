namespace TourPortal.Infrastructure.Global
{
    ...
    public static class Global
    {
        public static class Route
        {
            ...
            public const string DeleteUser = "api/administrator/deleteUser";
            public const string RegisterEmploye = "api/owner/registerEmploye";
            public const string DeleteEmployeData = "api/owner/deleteEmployeData";
            ...
            public const string ChangedRoom = "api/owner/changedRoom";
